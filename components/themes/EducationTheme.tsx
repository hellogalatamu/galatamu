...
interface EducationThemeProps {
  data: InvitationData;
  previewMode?: boolean;
  guestName?: string;
}

export default function EducationTheme({ data, previewMode = false, guestName = "Tamu Undangan" }: EducationThemeProps) {
  ...
  const calendarLink = generateGoogleCalendarLink(`Seminar/Workshop: ${data.bride_data.groom}`, data.event_data.date, data.event_data.akad_location);
  ...
  return (
    <div className={`bg-slate-900 min-h-screen text-yellow-400 font-sans selection:bg-[#1a1a1a] selection:text-white ${previewMode ? 'relative' : ''}`}>
          ...
          {!isOpen && (
            ...
            >
              ...
              <div className="relative z-10 text-center px-6">
                <FadeIn delay={0.2}>
                  <p className="tracking-widest uppercase text-xs mb-2 text-gray-300">Graduation</p>
                </FadeIn>
                ...
                <FadeIn delay={0.8}>
                  <button 
                    ...
                    className="px-8 py-3 bg-zinc-800 text-yellow-400 rounded-full font-medium hover:bg-gray-200 transition-colors shadow-lg flex items-center gap-2 mx-auto"
                  >
                    Buka Undangan
                  </button>
                </FadeIn>
        ...
        <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: previewMode ? 0 : 1 }} className="pb-32">
          ...
          <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
            ...
            <div className="relative z-10">
              <FadeIn><p className="tracking-widest uppercase text-sm mb-4 text-zinc-400">Graduation</p></FadeIn>
              <FadeIn delay={0.2}>
                <h2 className="font-serif text-6xl md:text-8xl font-bold mb-6">Farewell & Prom Night</h2>
              </FadeIn>
              <FadeIn delay={0.4}>
          ...
          <section className="relative py-24 px-6 bg-zinc-800 text-center overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              <FadeIn>
                <h3 className="font-serif text-4xl mb-6">{data.bride_data.groom || "Nama Sekolah"}</h3>
                <p className="text-zinc-300 mb-16 font-light max-w-2xl mx-auto">Theme: "Midnight in Paris"<br/>Mari rayakan malam terakhir masa putih abu-abu kita dengan penuh kenangan dan tawa.</p>
              </FadeIn>
          ...
          <section className="py-24 px-6 bg-[#f4f2e9] relative">
            <div className="max-w-2xl mx-auto">
              <FadeIn><h3 className="font-serif text-4xl mb-16 text-center">Perjalanan Pendidikan</h3></FadeIn>
          ...
          <section className="relative py-24 px-6 bg-zinc-800 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <FadeIn delay={0.2}>
                <div className="p-10 border border-zinc-800 rounded-[2rem] bg-slate-900 shadow-sm relative overflow-hidden group hover:shadow-md transition">
                  <h4 className="font-serif text-3xl mb-4">Main Event & Awards</h4>
              ...
              <FadeIn delay={0.4}>
                <div className="p-10 border border-zinc-800 rounded-[2rem] bg-slate-900 shadow-sm relative overflow-hidden group hover:shadow-md transition">
                  <h4 className="font-serif text-3xl mb-4">Perayaan</h4>
            ...
            <div className="max-w-2xl mx-auto relative z-10">
              ...
              <FadeIn delay={0.2}>
                ...
                >
                  ...
                  <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-zinc-800 text-yellow-400 font-medium rounded-xl flex justify-center items-center gap-2 hover:bg-gray-200 transition disabled:opacity-50"><Send size={18}/> {isSubmitting ? "Mengirim..." : "Kirim Ucapan"}</button>
                </form>
              </FadeIn>
      ...
      {isOpen && !previewMode && (
        <button onClick={toggleMusic} className="fixed bottom-6 right-6 z-40 p-4 rounded-full bg-zinc-800/30 backdrop-blur-md border border-white/40 shadow-lg text-yellow-400 hover:bg-zinc-800/50 transition-all">
