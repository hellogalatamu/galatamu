...
export default function AqiqahTheme({ data, previewMode = false, guestName = "Tamu Undangan" }: AqiqahThemeProps) {
  ...
  return (
    <div className={`bg-[#f5f9ff] min-h-screen text-[#2b4c7e] font-sans selection:bg-[#1a1a1a] selection:text-white ${previewMode ? 'relative' : ''}`}>
          ...
          {!isOpen && (
            ...
            >
              ...
              <div className="relative z-10 text-center px-6">
                <FadeIn delay={0.2}>
                  <p className="tracking-widest uppercase text-xs mb-2 text-gray-300">Tasyakuran Aqiqah</p>
                </FadeIn>
                ...
                <FadeIn delay={0.8}>
                  <button 
                    ...
                    className="px-8 py-3 bg-white text-[#2b4c7e] rounded-full font-medium hover:bg-gray-200 transition-colors shadow-lg flex items-center gap-2 mx-auto"
                  >
                    Buka Undangan
                  </button>
                </FadeIn>
        ...
        <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: previewMode ? 0 : 1 }} className="pb-32">
          ...
          <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
            ...
            <div className="relative z-10">
              <FadeIn><p className="tracking-widest uppercase text-sm mb-4 text-gray-500">Tasyakuran Aqiqah</p></FadeIn>
              <FadeIn delay={0.2}>
                <h2 className="font-serif text-6xl md:text-8xl font-bold mb-6">{data.bride_data.groom || "Nama Anak"}</h2>
              </FadeIn>
              <FadeIn delay={0.4}>
          ...
          <section className="relative py-24 px-6 bg-white text-center overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              <FadeIn>
                ...
                <p className="text-gray-600 mb-16 font-light max-w-2xl mx-auto italic">"Ya Allah, jadikanlah ia anak yang shalehah, berbakti kepada orang tua, dan berguna bagi agama."<br/><br/>Dengan memohon rahmat Allah SWT, kami mengundang Bapak/Ibu untuk hadir dalam acara Tasyakuran Aqiqah anak kami.</p>
              </FadeIn>
              <div className="flex justify-center">
                <FadeIn delay={0.2}>
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-sm text-gray-500 mb-4">Buah Hati Tercinta dari {data.bride_data.parents_groom || "Bapak & Ibu"}</p>
          ...
          <section className="py-24 px-6 bg-[#f4f2e9] relative">
            <div className="max-w-2xl mx-auto">
              <FadeIn><h3 className="font-serif text-4xl mb-16 text-center">Perjalanan Kami</h3></FadeIn>
          ...
          <section className="relative py-24 px-6 bg-white text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <FadeIn delay={0.2}>
                <div className="p-10 border border-gray-100 rounded-[2rem] bg-[#f5f9ff] shadow-sm relative overflow-hidden group hover:shadow-md transition">
                  <h4 className="font-serif text-3xl mb-4">Tasyakuran & Doa Bersama</h4>
              ...
              <FadeIn delay={0.4}>
                <div className="p-10 border border-gray-100 rounded-[2rem] bg-[#f5f9ff] shadow-sm relative overflow-hidden group hover:shadow-md transition">
                  <h4 className="font-serif text-3xl mb-4">Ramah Tamah</h4>
          ...
          {/* Galeri */}
          <section className="py-24 px-6 bg-[#f5f9ff]">
            ...
            <div className="max-w-2xl mx-auto relative z-10">
              ...
              <FadeIn delay={0.2}>
                ...
                >
                  ...
                  <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-white text-[#2b4c7e] font-medium rounded-xl flex justify-center items-center gap-2 hover:bg-gray-200 transition disabled:opacity-50"><Send size={18}/> {isSubmitting ? "Mengirim..." : "Kirim Ucapan"}</button>
                </form>
              </FadeIn>
      ...
      {isOpen && !previewMode && (
        <button onClick={toggleMusic} className="fixed bottom-6 right-6 z-40 p-4 rounded-full bg-white/30 backdrop-blur-md border border-white/40 shadow-lg text-[#2b4c7e] hover:bg-white/50 transition-all">
