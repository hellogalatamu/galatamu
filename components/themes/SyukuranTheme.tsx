...
interface SyukuranThemeProps {
  data: InvitationData;
  previewMode?: boolean;
  guestName?: string;
}

export default function SyukuranTheme({ data, previewMode = false, guestName = "Tamu Undangan" }: SyukuranThemeProps) {
  ...
  const calendarLink = generateGoogleCalendarLink(`Syukuran ${data.bride_data.groom}`, data.event_data.date, data.event_data.akad_location);
  ...
  return (
    <div className={`bg-[#fff8f0] min-h-screen text-[#5c4033] font-sans selection:bg-[#1a1a1a] selection:text-white ${previewMode ? 'relative' : ''}`}>
          ...
          {!isOpen && (
            ...
            >
              ...
              <div className="relative z-10 text-center px-6">
                <FadeIn delay={0.2}>
                  <p className="tracking-widest uppercase text-xs mb-2 text-gray-300">Syukuran Menempati Rumah Baru</p>
                </FadeIn>
                ...
                <FadeIn delay={0.8}>
                  <button 
                    ...
                    className="px-8 py-3 bg-white text-[#5c4033] rounded-full font-medium hover:bg-gray-200 transition-colors shadow-lg flex items-center gap-2 mx-auto"
                  >
                    Buka Undangan
                  </button>
                </FadeIn>
        ...
        <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: previewMode ? 0 : 1 }} className="pb-32">
          ...
          <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
            ...
            <div className="relative z-10">
              <FadeIn><p className="tracking-widest uppercase text-sm mb-4 text-gray-500">Syukuran Menempati Rumah Baru</p></FadeIn>
              <FadeIn delay={0.2}>
                <h2 className="font-serif text-6xl md:text-8xl font-bold mb-6">Keluarga {data.bride_data.groom || "Bapak/Ibu"}</h2>
              </FadeIn>
              <FadeIn delay={0.4}>
          ...
          <section className="relative py-24 px-6 bg-white text-center overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              <FadeIn>
                ...
                <p className="text-gray-600 mb-16 font-light max-w-2xl mx-auto">Kami mengundang Bapak/Ibu/Saudara/i untuk hadir pada acara syukuran dan doa bersama di kediaman baru kami.</p>
              </FadeIn>
          ...
          <section className="relative py-24 px-6 bg-white text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <FadeIn delay={0.2}>
                <div className="p-10 border border-gray-100 rounded-[2rem] bg-[#fff8f0] shadow-sm relative overflow-hidden group hover:shadow-md transition">
                  <h4 className="font-serif text-3xl mb-4">Pembacaan Doa & Yasin</h4>
              ...
              <FadeIn delay={0.4}>
                <div className="p-10 border border-gray-100 rounded-[2rem] bg-[#fff8f0] shadow-sm relative overflow-hidden group hover:shadow-md transition">
                  <h4 className="font-serif text-3xl mb-4">Ramah Tamah & Makan Malam</h4>
            ...
            <div className="max-w-2xl mx-auto relative z-10">
              ...
              <FadeIn delay={0.2}>
                ...
                >
                  ...
                  <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-white text-[#5c4033] font-medium rounded-xl flex justify-center items-center gap-2 hover:bg-gray-200 transition disabled:opacity-50"><Send size={18}/> {isSubmitting ? "Mengirim..." : "Kirim Ucapan"}</button>
                </form>
              </FadeIn>
      ...
      {isOpen && !previewMode && (
        <button onClick={toggleMusic} className="fixed bottom-6 right-6 z-40 p-4 rounded-full bg-white/30 backdrop-blur-md border border-white/40 shadow-lg text-[#5c4033] hover:bg-white/50 transition-all">
